...
#    Updated: 2019/11/28 17:29:39 by jhallama         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILLIT = srcs/create_tetriminos.c srcs/main.c srcs/map_validator.c srcs/tetriminos_into_alphabet.c srcs/new_map.c srcs/list_maker.c
...
clean:
	/bin/rm -f $(LIBFTOBJ) create_tetriminos.o main.o map_validator.o tetriminos_into_alphabet.o new_map.o list_maker.o
