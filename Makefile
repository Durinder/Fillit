...
#    Updated: 2019/11/25 18:37:56 by jhallama         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILLIT = srcs/create_tetriminos.c srcs/main.c

HEADERS = -I libft/libft.h -I libft/get_next_line.h
...
clean:
	/bin/rm -f $(LIBFTOBJ) create_tetriminos3.o main.o
